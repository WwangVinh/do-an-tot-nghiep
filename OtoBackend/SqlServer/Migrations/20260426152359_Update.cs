    ...
    public partial class Update : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Bookings__3214EC07B3AB1A46", x => x.BookingId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoleTarget = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Notifications_Showrooms_ShowroomId",
                        column: x => x.ShowroomId,
                        principalTable: "Showrooms",
                        principalColumn: "ShowroomId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notifications_ShowroomId",
                table: "Notifications",
                column: "ShowroomId");
