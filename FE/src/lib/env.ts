...
// const NGROK_URL = 'https://spinulose-polishedly-enrique.ngrok-free.dev'
...
//     z.string().optional().default(NGROK_URL),
//   ),
// })
...
// export const env = {
//   VITE_API_BASE_URL: normalizeApiBase(parsed.VITE_API_BASE_URL ?? NGROK_URL),
// }